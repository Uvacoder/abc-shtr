const Logo = () => {
  return (
    <div className="flex font-medium items-center text-2xl gap-2">
      <svg
        viewBox="0 0 50 50"
        className="h-8 max-h-full text-primary-500  w-8 md:h-12 md:w-12"
      ...
      >
        ...
        >
          <g className="fill-primary-500">
            <g
              transform="translate(-17.325 -17.325) scale(0.35)"
              id="container"
            >
              <g className="fill-primary-500">
                <rect
